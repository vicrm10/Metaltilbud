Public Class metal_tilbud
    ...
    'gruppe5
    Private pobjFilter_tb_gruppe5_uk As FilterKeys
    'gruppe6
    ...
    Private Sub metal_tilbud_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim odbc As New ODBCConnection

        odbc.CreateDSN("MetalTilbud", _
              "MetalTilbud", _
              "MetalTilbud", _
              "SQL Server", _
    ...
    Private Function CalculatePresstag(ByVal iNumberOfSubjects As Integer, ByVal iNumberOfNuts As Integer) As Double
        ...
        objDatabaseIO = New DatabaseIO
        lb_presstag_kr.Text = objDatabaseIO.getpresstagprice(Val(Lb_matrgruppe.Text)) * iNumberOfNuts
    ...
    Private Sub CalculateBendTime(ByVal subjectweight As Double, ByVal Antal As Double)
        ...
        lb_buk_ialt.Text = FormatNumber(sum + bendstart, 0)
    ...
    Private Function CalculateWelding(ByVal antal As Integer) As Double
        ...
        If cb_weld.CheckState = CheckState.Checked Then
            ...
            Totalweldingtime = FormatNumber(weldingtimemin + weldinghandling, 0)
        ...
        If cb_tackweld.CheckState = CheckState.Checked Then
            ...
            weldingtimemin = antal * weldspeed * weldlength * weldspeedmultiplier / 100
            Totaltackweldingtime = FormatNumber(weldingtimemin + weldinghandling, 0)
    ...
    Private Sub CalculateManHourSubtotal(ByVal Antal As Double)
        ...
        objDatabaseIO = New DatabaseIO
        Dim SumcalculatedTime As Double


        'Summing
        SumcalculatedTime = Convert.ToDouble(Val(lb_buk_tid.Text)) + Convert.ToDouble(Val(lb_valsetid.Text)) + Convert.ToDouble(Val(lb_klip_tid.Text)) + Convert.ToDouble(Val(lb_afgrat.Text)) + Convert.ToDouble(Val(lb_grinding.Text)) + Convert.ToDouble(Val(lb_brush.Text)) + Convert.ToDouble(Val(lb_vibration.Text)) + Convert.ToDouble(Val(lb_rette.Text)) + Convert.ToDouble(Val(lb_stans_manuel.Text)) + Convert.ToDouble(Val(lb_countersink.Text)) + Convert.ToDouble(Val(lb_gevind.Text)) + Convert.ToDouble(Val(lb_pressnut.Text)) + Convert.ToDouble(Val(lb_presstag.Text)) + Convert.ToDouble(Val(lb_boltesvejs.Text)) + Convert.ToDouble(Val(lb_spotweld.Text)) + Convert.ToDouble(Val(lb_tackweld.Text)) + Convert.ToDouble(Val(lb_weld.Text)) + Convert.ToDouble(Val(lb_rettesvejs_tid.Text)) + Convert.ToDouble(Val(lb_grind_weld.Text)) + Convert.ToDouble(Val(lb_gruppe5.Text))
        dblSubcalculatedTime = ((Convert.ToDouble(Val(lb_buk_tid.Text)) + Convert.ToDouble(Val(lb_valsetid.Text)) + Convert.ToDouble(Val(lb_klip_tid.Text)) + Convert.ToDouble(Val(lb_afgrat.Text)) + Convert.ToDouble(Val(lb_grinding.Text)) + Convert.ToDouble(Val(lb_brush.Text)) + Convert.ToDouble(Val(lb_vibration.Text)) + Convert.ToDouble(Val(lb_rette.Text)) + Convert.ToDouble(Val(lb_stans_manuel.Text)) + Convert.ToDouble(Val(lb_countersink.Text)) + Convert.ToDouble(Val(lb_gevind.Text)) + Convert.ToDouble(Val(lb_pressnut.Text)) + Convert.ToDouble(Val(lb_presstag.Text)) + Convert.ToDouble(Val(lb_boltesvejs.Text)) + Convert.ToDouble(Val(lb_spotweld.Text)) + Convert.ToDouble(Val(lb_tackweld.Text)) + Convert.ToDouble(Val(lb_weld.Text)) + Convert.ToDouble(Val(lb_rettesvejs_tid.Text)) + Convert.ToDouble(Val(lb_grind_weld.Text)) + Convert.ToDouble(Val(lb_gruppe5.Text))) / 60)
        dblSubtotalTime = ((Val(pobjFilter_tb_buk_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_valsning_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_klip_tid_uk.GetValue) + Val(pobjFilter_tb_afgrat_uk.GetValue) + Val(pobjFilter_tb_grinding_uk.GetValue) + Val(pobjFilter_tb_brush_uk.GetValue) + Val(pobjFilter_tb_vibration_uk.GetValue) + Val(pobjFilter_tb_rette_uk.GetValue) + Val(pobjFilter_tb_stans_manuel_uk.GetValue) + Val(pobjFilter_tb_countersink_uk.GetValue) + Val(pobjFilter_tb_gevind_uk.GetValue) + Val(pobjFilter_tb_pressnut_uk.GetValue) + Val(pobjFilter_tb_presstag_uk.GetValue) + Val(pobjFilter_tb_boltesvejs_uk.GetValue) + Val(pobjFilter_tb_spotweld_uk.GetValue) + Val(pobjFilter_tb_tackweld_uk.GetValue) + Val(pobjFilter_tb_weld_uk.GetValue) + Val(pobjFilter_tb_rettesvejs_uk.GetValue) + Val(pobjFilter_tb_grind_weld_uk.GetValue) + Val(pobjFilter_tb_gruppe5_uk.GetValue)) / 60)

        If Antal = Val(tb_antal1.Text) Then
            uk_correction1 = (dblSubtotalTime - dblSubcalculatedTime)
            lb_ukTime.Text = uk_correction1
        End If

        uk_correction = Convert.ToDouble(lb_ukTime.Text) / Convert.ToDouble(tb_antal1.Text) * Antal

        dblSubtotal = (dblSubcalculatedTime + uk_correction) * Val(tb_timesats_mand.Text)
    ...
    Private Sub CalculateCNCHourSubtotal(ByVal Antal As Double)
        ...
        lb_buk_ialtuk.Text = (Convert.ToDouble(pobjFilter_tb_buk_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_buk_opst_uk.GetValue))
        If rb_klip.Checked = True Then
    ...
    Private Sub CalculatePurchasingSubtotal(ByVal Antal As Double)
        ...
        indkøb1 = (CalculateSurfaceTreatment(Antal) + (pressnut + presstag + svejsestag + tilsatsmatr) * Antal)
    ...
    Public Sub CalculateGrouphours()
        ...
        If lb_gruppetid2.Text = 0.0 Then
            lb_gruppetid2.Text = ""
        End If
        lb_gruppetid3.Text = FormatNumber((Convert.ToDouble(pobjFilter_tb_buk_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_buk_opst_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_valsning_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_spotweld_uk.GetValue)) / 60, 2)
        If lb_gruppetid3.Text = 0.0 Then
            lb_gruppetid3.Text = ""
        End If
        lb_gruppetid4.Text = FormatNumber((Convert.ToDouble(pobjFilter_tb_tackweld_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_weld_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_rettesvejs_uk.GetValue) + Convert.ToDouble(pobjFilter_tb_grind_weld_uk.GetValue)) / 60, 2)
        ...
        If lb_gruppetid5.Text = 0.0 Then
            lb_gruppetid5.Text = ""
        End If
        lb_gruppetid5slib.Text = FormatNumber((Convert.ToDouble(pobjFilter_tb_gruppe5_uk.GetValue)) / 60, 2)
    ...
    Public Sub CalculateAll(ByVal Antal As Double)
        ...
        CalculateSteelmaster(Val(Antal), lb_udfold_x.Text, lb_udfold_y.Text)
    ...
    Public Sub CalculateSurface1()
        ...
        If cb_overfl_beh1.Text = "Pulverlak" Then
            If cb_overfl_leverandør1.Text = "Laduco" Then
                ...
                tb_overfl_afdæk1.Text = 1.25
                stkppris = 120 * areal * Faktor
                tb_overfl_pris1.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør1.Text = "Milling Industrilakering" Then
        ...
        If cb_overfl_beh1.Text = "Chromit (jern)" Then
            If cb_overfl_leverandør1.Text = "Værløse Galvaniske" Then
                tb_overfl_opstart1.Text = 100
                tb_overfl_afdæk1.Text = 0
                stkppris = 100 * areal * 2
                tb_overfl_pris1.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør1.Text = "Stjernecrom" Then
                tb_overfl_opstart1.Text = 200
                tb_overfl_afdæk1.Text = 0
                stkppris = 130 * areal * 2
                tb_overfl_pris1.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør1.Text = "Croma" Then
                tb_overfl_opstart1.Text = 210
                tb_overfl_afdæk1.Text = 0
                stkppris = 140 * areal * 2
                tb_overfl_pris1.Text = FormatNumber(stkppris, 2)
            End If
        End If
        If cb_overfl_beh1.Text = "ChromitAL (alu)" Then
            ...
            If cb_overfl_leverandør1.Text = "Croma" Then
                ...
                tb_overfl_pris1.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør1.Text = "Aluskan" Then
    ...
    Public Sub CalculateSurface2()
        ...
        If cb_overfl_beh2.Text = "Pulverlak" Then
            If cb_overfl_leverandør2.Text = "Laduco" Then
                ...
                tb_overfl_afdæk2.Text = 1.25
                stkppris = 120 * areal * Faktor
                tb_overfl_pris2.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør2.Text = "Milling Industrilakering" Then
        ...
        If cb_overfl_beh2.Text = "ChromitAL (alu)" Then
            ...
            If cb_overfl_leverandør2.Text = "Croma" Then
                ...
                tb_overfl_pris2.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør2.Text = "Aluskan" Then
    ...
    Public Sub CalculateSurface3()
        ...
        If cb_overfl_beh3.Text = "Pulverlak" Then
            If cb_overfl_leverandør3.Text = "Laduco" Then
                ...
                tb_overfl_afdæk3.Text = 1.25
                stkppris = 120 * areal * Faktor
                tb_overfl_pris3.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør3.Text = "Milling Industrilakering" Then
        ...
        If cb_overfl_beh3.Text = "ChromitAL (alu)" Then
            ...
            If cb_overfl_leverandør3.Text = "Croma" Then
                ...
                tb_overfl_pris3.Text = FormatNumber(stkppris, 2)
            End If
            If cb_overfl_leverandør3.Text = "Aluskan" Then
    ...
    Public Sub New()
        ...
        'gruppe5
        pobjFilter_tb_gruppe5_uk = New FilterKeys(tb_gruppe5_uk, lb_gruppe5, Me)
        'gruppe6
    ...
    Private Sub rb_danmark_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rb_danmark.CheckedChanged
        If rb_danmark.Checked = True Then
            tb_timesats_mand.Text = 500
            tb_timesats_D.Text = 600
            tb_timesats_B.Text = 1900
            tb_timesats_C.Text = 1900
        Else
            tb_timesats_mand.Text = 300
            tb_timesats_D.Text = 450
            tb_timesats_B.Text = 1200
    ...
    Private Sub bu_gem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bu_gem.Click
        ...
        lb_filnavn.Text = sKundenavn & "_" & sFilename & ".xls"
        ...
        Try
            ...
            wb = ex.Workbooks.Open("\\Win2000server\AKS Metal\Tilbud\Tilbudsfiler\tilbudsdata.xlt")
        ...
        sheet.Cells(3, 4) = Me.lb_operatør.Text
        sheet.Cells(4, 4) = Me.lb_dato.Text
        ...
        sheet.Cells(219, 4) = Me.tb_gruppe5_uk.Text
        ...
        wb.SaveAs("\\Win2000server\AKS Metal\Tilbud\Tilbudsfiler\" & filnavn & " ")
    ...
    Private Sub bu_hent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bu_hent.Click
        ...
        'DK
        FileDialog.InitialDirectory = "\\Win2000server\AKS Metal\Tilbud\Tilbudsfiler\"
        'Polen
        ...
        Try
            ...
            Me.tb_gruppe5_uk.Text = sheet.Cells(219, 4).value
